...
def send_weekly_report(tg_chat_ids: list[str] | None = None) -> tuple[bool, str]:
    ...
    pat_html = ""
    if patterns:
        pat_html = ("<h4 style='color:#FFB340;margin:18px 0 6px;'>⚠️ Failure patterns this week</h4>"
    ...
    body = (
        ...
        f"<h4 style='color:#00C48C;margin:8px 0 6px;'>🏆 Top winners</h4>"
